        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            ...
                            <p>HHBIOS (C)2000 Abdullah Sarder Inc.,</p>
                        </div>
                    </div>
                        ...
                        {showLoadingResources && doneLoading && (
                            <p>
                                ...
                                <b style={styles.green}>
                                    'Abdullah Sarder Portfolio Showcase'
                                </b>{' '}
                                V1.0
                            </p>
                        )}
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Abdullah Sarder Portfolio Showcase 2022</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
                    ...
                    <div style={styles.startPopup}>
                        ...
                        <p>
                            ...
                            <a
                                style={styles.link}
                                href={
                                    'https://github.com/AbdullahSarder/abdullah_portfolio_inner'
                                }
                            >
                                bug in firefox
                            </a>
